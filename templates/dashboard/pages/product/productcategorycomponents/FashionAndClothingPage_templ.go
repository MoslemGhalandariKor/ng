...
func FashionAndClothingPage(categoryInfo []product_management.CategoryView) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, category := range categoryInfo {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/dashboard/pages/product/productcategorycomponents/FashionAndClothingPage.templ`, Line: 25, Col: 41}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/dashboard/pages/product/productcategorycomponents/FashionAndClothingPage.templ`, Line: 25, Col: 59}
			}
